...
class GetAllStatusLogUseCase @Inject constructor(private val repository: IFleetRepository) {
    operator fun invoke(): Flow<List<StatusLog>> = repository.getAllStatusLog()
}