...
class FleetRepository @Inject constructor(
    ...
    override suspend fun insertStatusLog(statusLog: StatusLog) {
        val entity = statusLog.let { DataMapper.mapDomaintoEntity(statusLog) }
        localDataSource.insertStatusLog(entity)
    }
    ...
    override suspend fun getSession(): Flow<User> {
    ...
    override suspend fun login(user: User) {
        ...
        localDataSource.saveUserSession(userEntity)
    }
